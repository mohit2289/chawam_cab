...
1.Create a user or vender account.<br/>
2.Make purchases or register cars.<br/>
3.Request Vehicle.<br/>
4.Your Login, Pickup & Drop Locations.<br/>
5.Request information about Bookings.<br/>
6.Participate in offers on app. Participate in promotions, contests, or giveaways.<br/>
7.Submit questions or feedbacks.<br/><br/>

Personal data trilokicabs.com collect online may also be combined with personal data you provide to us through offline channels such as through a call center support team.
<br/><br/>
We may collect contact information through other sources, such as list vendors, clients. When we do so, we ask the vendors to confirm that the information was legally acquired by the third party and that we have the right to obtain it from them and use it.
<br/><br/>
<h5>Information Sharing and Discusser of personal information </h5>
...
We collect personal information automatically when you:<br/>
1.Search for, visit, interact with, or use our services including registration.<br/>
2.Access, use, or download content from us.<br/>
3.Open emails or click on links in emails or advertisements from us.<br/>
4.Otherwise interact or communicate with us (such as when you attend one of our events or locations, when you request support or send us information, or when you mention or post to our social media accounts).
<br/><br/>
...
1. The free ride coupons are applicable on economy, Sedan and Prime rides only.<br/>
2. The coupon is applicable on one ride only.<br/>
3. Any user who signs-up a referral code will get a coupon worth the value of the referral program at the time of sign-up. These values may change if our referral program changes during the sign-up.
<br/>a. You too will receive free ride coupons depending on the referral program that is running when your friend signs-up once he/she completes the first ride.
